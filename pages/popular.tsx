...
import { Navbar, Nav, Image, Container, Row, Col, Form, FormControl, Button } from 'react-bootstrap';
...
const result = await axios.get<Anime[]>('https://gogoanime.consumet.stream/popular');
...
<h1 style={{ textAlign: 'center', marginTop: '30px', marginBottom: '50px' }}>Animes Populares</h1>
{loading ? (
